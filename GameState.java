...
public class GameState {
	...
	private int turn = 0;
	private ArrayList <String> transcription = new ArrayList <String>();
	...
	public ArrayList <String> getTranscription(){return this.transcription;}
	...
	public boolean[][] getAllLegalMovesBool(Player p) {
		boolean [][] boolMoves = new boolean [8][8];
		ArrayList<Point> legalMoves = getAllLegalMoves(p);
	...
	public boolean gameFinished(GameState g) {return !g.hasLegalMoves(g.getPlayer(BLACK))&&!g.hasLegalMoves(g.getPlayer(WHITE));}

	/*While the game is not finished saves in the ArrayList the moves made by each player.
	 * When the game is over we will save the transcription in a file in the Othello class.
*/
    public void writeGame(int row, int col) {
	    		/*Example: 0.-d2
	    		 *		   0.-c2
	    		 *			...
	    		 *			End of game. Score :
	    		 ...
	    		 */
    			getTranscription().add(""+getTurn() + " : " + transcriptCol(col)+(row+1)+"\n");	
